...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="<?= base_url('assets/template/'); ?>media/favicons/favicon-192x192.png">
        <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url('assets/template/'); ?>media/favicons/apple-touch-icon-180x180.png">
        <!-- END Icons -->
    ...
    <body>
                                    ...
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        ...
                                        <div class="mb-2 text-center">
                                            <a class="link-fx font-w700 font-size-h1" href="index.html">
                                                <span class="text-dark">Asmara</span>
                                            </a>
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                <button type="submit"  name="simpan" value="simpan" class="btn btn-block btn-hero-primary">
        ...
        <!-- Page JS Plugins -->
        <script src="<?= base_url('assets/template/'); ?>js/plugins/jquery-validation/jquery.validate.min.js"></script>

        <!-- Page JS Code -->
        <!-- <script src="<?= base_url('assets/template/'); ?>js/pages/op_auth_signin.min.js"></script> -->
    </body>
</html>
